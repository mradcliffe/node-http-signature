...
const { fingerprint, sshKeyToPEM, pemToRsaSSHKey } = require('./utils');
const { getfromRequest } = require('./signature-method');
...
module.exports = {
  ...
  // Deprecated functions maintained for backwards-compatibility.
